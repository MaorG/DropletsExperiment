...
if nnn < 1
    ...
    plot(xq([1,end]),[-1,-1],'k--','LineWidth', 2);
    plot(xq,yrel,'r-','LineWidth', 3);
elseif nnn == 3
    plot(xq,yrel,'Color', [0,0,0.5], 'LineWidth', 3);
else
%    plot(xq,yrel,'Color', [0.5*rand(),0.5*rand(),0.7*rand()+0.3],'LineWidth', 1.5)
grayColor = 0.6+0.4*rand();
plot(xq,yrel,'Color', [grayColor,grayColor,grayColor],'LineWidth', 1)
end
ylim auto
yl = ylim
